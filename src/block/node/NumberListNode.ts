...
const createNumberListNode: NodeCreator<NumberListNode | PlainNode> = ([raw], opts) => {
...
export const NumberListNodeParser: NodeParser = createNodeParser(createNumberListNode, {
  parseOnNested: false,
  parseOnQuoted: false,
