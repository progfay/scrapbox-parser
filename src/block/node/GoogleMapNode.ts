...
const createGoogleMapNode: NodeCreator<GoogleMapNode | PlainNode> = (match, opts) => {
  const raw = match[0];
...
export const GoogleMapNodeParser: NodeParser = createNodeParser(createGoogleMapNode, {
  parseOnNested: false,
  parseOnQuoted: true,
