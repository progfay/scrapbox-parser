...
const createStrongImageNode: NodeCreator<StrongImageNode | PlainNode> = ([raw], opts) => {
...
export const StrongImageNodeParser: NodeParser = createNodeParser(createStrongImageNode, {
  parseOnNested: false,
  parseOnQuoted: true,
